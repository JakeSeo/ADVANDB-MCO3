...
public class DBClientGUI {

	private static DBClient cClient;
	...
	public static void ConfigureMainWindow()
	{
		...
		TF_Message.setForeground(new java.awt.Color(0, 0, 250));
		...
		String[] TestNames = {"Winona", "Shayane", "Rissa", "Avril"};
	...
	public static void ACTION_B_ENTER()
	{
		if(!TF_UserNameBox.getText().equals(""))
		{
			...
			DBServer.CurrentUsers.add(UserName);
			MainWindow.setTitle(UserName + "'s Chat Box");
	...
	public static void ACTION_B_SEND()
	{
		...
		{
			cClient.SEND(TF_Message.getText());
			TF_Message.requestFocus();
		}
	}
